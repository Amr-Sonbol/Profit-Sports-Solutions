...
class CustomerAdmin(admin.ModelAdmin):
    list_display = ['name', 'code', 'country', 'segment', 'contact_name', 'contact_phone', 'contact_email', 'user', 'is_active']
    search_fields = ['name', 'code', 'contact_name', 'contact_email', 'user__username']
